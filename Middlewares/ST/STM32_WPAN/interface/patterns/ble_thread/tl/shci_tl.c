 ...
 */
#if 1
__attribute__((section ("SYSTEM_DRIVER_CONTEXT")))  static tListNode SHciAsynchEventQueue;
__attribute__((section ("SYSTEM_DRIVER_CONTEXT"))) static volatile SHCI_TL_CmdStatus_t SHCICmdStatus;
__attribute__((section ("SYSTEM_DRIVER_CONTEXT"))) static TL_CmdPacket_t *pCmdBuffer;
__attribute__((section ("SYSTEM_DRIVER_CONTEXT"))) SHCI_TL_UserEventFlowStatus_t SHCI_TL_UserEventFlow;
#else
