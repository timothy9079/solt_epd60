 ...
 */
//#define CFG_DEBUG_TRACE_UART    hw_uart1   //timothy
...
#define APP_DBG_MSG(__info,...) do {printf("Debug: [%s][%s][%d] \r\n ", DbgTraceGetFileName(__FILE__),__FUNCTION__,__LINE__);printf( __info"\r\n",##__VA_ARGS__);}while(0);
#else
